        ...
        findViewById(R.id.push).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!(TextUtils.isEmpty(header))&&!(TextUtils.isEmpty(content))){
                    ...
                    Toast.makeText(NotificationActivity.this,"Fields cannot be empty!!",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    class NotificationTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... strings) {
            try {
                ...
                con.setDoInput(true);
//                2305c53b-8684-4f80-a67a-5a6237db8665
//                NWRjNWY3MGUtNDE0MC00NTM4LTlhOWUtMTdlMzE2MTE2N2I5
